"""
Django settings for IPTVAdmin project.
...
EXTRA_APPS = [
    'IPTVAdmin.core.apps.AuditlogCustomConfig',
...
WSGI_APPLICATION = 'IPTVAdmin.wsgi.application'
...
if DEFAULT_FILE_STORAGE == 'django.core.files.storage.FileSystemStorage':
    MEDIA_ROOT = config('MEDIA_ROOT', default=os.path.join(BASE_DIR, 'IPTVAdmin/media'))
